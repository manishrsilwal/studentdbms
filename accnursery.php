...
<style>
	...
	<title>Account Status of Nursery</title>
</head>
<body>
...
<div class="container">
<h2 style="text-align: center;"><font size="16">A</font>ccount <font size="16">S</font>tatus <font size="16">O</font>f <font size="16">N</font>ursery</h2>

<?php
$qry="SELECT * FROM studentinfo INNER JOIN payment_status ON studentinfo.student_id = payment_status.student_id WHERE studentinfo.adgrade='Nursery' ";
