...
<style>
	...
	<title>Account Status of UKG</title>
</head>
<body>
...
<div class="container">
<h2 style="text-align: center;"><font size="16">A</font>ccount <font size="16">S</font>tatus <font size="16">O</font>f <font size="16">U</font>KG</h2>

<?php
$qry="SELECT * FROM studentinfo INNER JOIN payment_status ON studentinfo.student_id = payment_status.student_id WHERE studentinfo.adgrade='UKG' ";
