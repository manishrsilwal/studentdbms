...
$qry="INSERT INTO `login` (`username`, `password`, `role`) VALUES ('$username', '$password', 'accountadmin')";
...
<style>
	...
	<title>Student Information System::Register New Account Admin</title>
</head>
<body>
...
<div class="top" align="center"><h3>Add New Account Administrator</h3><h5 style="color: red;"><i>(You cannot leave * marked fileds empty)</i></h5></div>
<form action="#" method="POST">
<div class="row">
	<div class="col-lg-6">
		<div class="form-group">
         <label for="username"><h5>Account Admin's Username:*</h5></label>
