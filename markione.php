...
<style>
	...
	<title>First Term::Grade I</title>
</head>
<body>
...
<h2 style="text-align: center;"><font size="16">E</font>xam <font size="16">M</font>ark <font size="16">S</font>heet</h2>
    <h3 style="margin-top: 50px; text-align: center;">First Terminal Exam Performance in Grade One:</h3>

<?php
$qry="SELECT *,(marks1.English + marks1.Nepali + marks1.Science + marks1.Math + marks1.Social + marks1.Computer) AS total FROM studentinfo INNER JOIN marks1 ON studentinfo.student_id = marks1.student_id WHERE studentinfo.adgrade=1";
