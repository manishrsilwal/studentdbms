...
<a href="../home.php" class="btn btn-primary" role="button" target="_top">Grade List</a>

<a href="../logout.php" class="btn btn-primary pull-right" role="button"  target="_top">Logout</a>


<div class="container">
<h3 style="text-align: center; margin-bottom: 30px;">Showing all Students of Grade 1:</h3>
<?php
$qry="SELECT * FROM studentinfo INNER JOIN parents ON studentinfo.student_id = parents.student_id WHERE studentinfo.adgrade=1";
$result = $db->query($qry);
