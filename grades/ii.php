...
<div class="container">
<h3 style="text-align: center; margin-bottom: 30px;">Showing all Students of Grade 2:</h3>
<?php
$qry="SELECT * FROM studentinfo INNER JOIN parents ON studentinfo.student_id = parents.student_id WHERE studentinfo.adgrade=2";
$result = $db->query($qry);
